...
public class DrConnectionCheckTest {

    private DrConnectionCheck drConnectionCheck;
    ...
    public void testCheckUnhealthy() throws Exception {
        ...
        thenCheckShouldReturn(CADSHealthCheck.Result.unhealthy("dr ping failed: 503."));
    }
    ...
    private void thenCheckShouldReturn(final CADSHealthCheck.Result result) {
        assertThat(drConnectionCheck.check(), is(result));
    }

    private void thenCheckShouldReturn(final String result) {
        assertThat(drConnectionCheck.check().toString(), is(result));
    }
}